...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ergodox_pretty(
		KC_GRV , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_6   ,  LT2BS  , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_BSPC,
		KC_TAB , KC_Q   , KC_W   , KC_E   , KC_R   , KC_T   , KC_EQL ,  KC_MINS, KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , MONEYQ ,
		CTLESC , KC_A   , KC_S   , KC_D   , KC_F   , KC_G   ,                    KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT,
		KC_LSFT, KC_Z   , KC_B   , KC_X   , KC_C   , KC_V   , KC_B   ,  KC_B   , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
		CTLDEL , KC_F1  , LT1EQ  , KC_LALT, KC_LGUI,                                      KC_RGUI, KC_RALT, ALTMN  , KC_LBRC, KC_RBRC,
	...
	[3] = LAYOUT_ergodox_pretty(
		_______, _______, _______, _______, _______, _______, _______,  KC_PIPE, KC_CIRC, KC_AMPR, KC_PAST, KC_LPRN, KC_RPRN, _______,
		...
		_______, _______, _______, _______, _______,                                     _______, _______, _______, KC_LPRN, KC_RPRN,
		                                             _______, _______,  KC_F14 , KC_F15 ,
		                                                      _______,  KC_F13 ,
		                                    _______, _______, _______,  KC_F16 , _______, _______
	),
};
